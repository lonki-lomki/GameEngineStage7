...
namespace GameEngineStage7
{
    public partial class Form1 : Form
    {
        ...
        // TODO: LERP - проверка коллизии между точками (текущая позиция снаряда - новая позиция снаряда)
        // TODO: запрет повторного выстрела, если предыдущий еще не окончен
        // TODO: осыпание земли после окончания выстрела
        // TODO: реализация метода OnDamage для танка
        // TODO: выровнять позицию взрыва (сместилось вниз)
        // TODO: настроить параметры физики
        // TODO: изображение танка вместо прямоугольника
